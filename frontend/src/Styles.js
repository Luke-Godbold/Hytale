...
export const card = "bg-stone-200 text-black lg:w-3/10 md:w-1/2 w-3/4 rounded-2xl justify-self-center flex flex-col items-center gap-5 mt-40 p-5"
...
export const button = "rounded-2xl bg-blue-700 cursor-pointer py-3 lg:w-1/5 md:w-1/3 w-1/2 text-white hover:bg-blue-500 outline-1 outline-black"
