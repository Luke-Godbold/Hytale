...
// Started making the sign in forms frontend

// 21/01/2026
// I added inputs for email and password
...
function SignIn() {
  ...
  // This sets the name of the tab to be Sign In - Hytale
  useEffect(()=>{
    document.title="Sign In - Hytale"})
  ...
  return (
    ...
    <div className="w-full">
        ...
        <div className={card + " mt-40"}>
            ...
            <button className={button} onClick={() => SignInRequest()}>Sign In</button>
            <p className='flex gap-1 flex-wrap'>Don't have an account? <Link to='/SignUp' className={linkText}>Sign Up</Link></p>
